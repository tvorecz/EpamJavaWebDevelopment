...
public class TetrahedronXCoordinateUpdaterImpl extends TetrahedronCommonUpdaterImpl {
	private PointFieldTetrahedronAccessor pointFieldTetrahedronAccessor;
	private double variationValue;
	private CalculateUpdatingValue calculateUpdatingValue;

	public TetrahedronXCoordinateUpdaterImpl(PointFieldTetrahedronAccessor pointFieldTetrahedronAccessor,
