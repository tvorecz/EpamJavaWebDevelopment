...
public class TetrahedronCreatorImpl implements TetrahedronCreator {
	...
	public TetrahedronCreatorImpl(TextFileReader textFileReader,
								  CoordinatesTetrahedronParser coordinatesTetrahedronParser,
								  String uri) {
	...
	public List<Tetrahedron> createTetraherdons() {
		...
		try {
			...
			List<double[][]> tetrahedronsCoordinates = coordinatesTetrahedronParser.parseTetrahedronsVertexesCoordinates(
					linesWithTetrahedronCoordinates);
