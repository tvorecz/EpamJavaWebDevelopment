...
public class TetrahedronBetweenIntegerSpecificationImpl extends TetrahedronCommonSpecificationImpl {
	...
	public boolean isSatisfiedBy(Tetrahedron tetrahedron) {
		return (betweenIntegerTetrahedronCriterionImpl.criterionMinValue() <= betweenIntegerTetrahedronCriterionImpl.extractTetrahedronField(tetrahedron)) && (betweenIntegerTetrahedronCriterionImpl.extractTetrahedronField(tetrahedron) <= betweenIntegerTetrahedronCriterionImpl.criterionMaxValue());
	}
}
