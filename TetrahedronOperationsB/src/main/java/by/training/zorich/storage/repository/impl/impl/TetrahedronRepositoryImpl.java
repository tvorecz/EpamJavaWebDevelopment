package by.training.zorich.storage.repository.impl.impl;
...
import by.training.zorich.storage.event.impl.arg.AdditionTetrahedronEventArg;
import by.training.zorich.storage.event.impl.arg.ModificationTetrahedronEventArg;
import by.training.zorich.storage.event.impl.arg.RemovalTetrahedronEventArg;
...
public class TetrahedronRepositoryImpl implements TetrahedronRepository {
	...
	private Tetrahedron cloneTetrahedron(Tetrahedron tetrahedron) {
		...
		clonedTetrahedron.setName(tetrahedron.getName());
