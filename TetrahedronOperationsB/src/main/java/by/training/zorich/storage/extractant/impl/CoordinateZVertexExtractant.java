...
public class CoordinateZVertexExtractant implements CoordinateExtractant {
	PointExtractant pointExtractant;

	public CoordinateZVertexExtractant(PointExtractant pointExtractant) {
		this.pointExtractant = pointExtractant;
	}

	@Override
	public double getValue(Tetrahedron tetrahedron) {
		return pointExtractant.getValue(tetrahedron).getCoordinateZ();
	}
}
