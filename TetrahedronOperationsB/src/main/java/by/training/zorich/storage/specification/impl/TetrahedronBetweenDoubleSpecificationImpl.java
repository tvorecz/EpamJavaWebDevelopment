...
public class TetrahedronBetweenDoubleSpecificationImpl extends TetrahedronCommonSpecificationImpl {
	...
	public boolean isSatisfiedBy(Tetrahedron tetrahedron) {
		return (betweenDoubleTetrahedronCriterion.criterionMinValue() <= betweenDoubleTetrahedronCriterion.extractTetrahedronField(
				tetrahedron)) && (betweenDoubleTetrahedronCriterion.extractTetrahedronField(tetrahedron) <= betweenDoubleTetrahedronCriterion
				.criterionMaxValue());
	}
}
