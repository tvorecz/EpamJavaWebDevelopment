...
public class BetweenTetrahedronCriterionTest {
	...
	public void testBetweenDoubleTetrahedronCriterionField() {
		BetweenTetrahedronCriterion betweenTetrahedronCriterion = new BetweenDoubleTetrahedronCriterionImpl(new CoordinateXVertexTetrahedronAccessorImpl(new VertexATetrahedronTetrahedronAccessorImpl()), minDouble, maxDouble);
