...
import by.training.zorich.storage.specification.impl.impl.*;
...
public class TetrahedronSpecificationTest {
	...
	public void TetrahedronEqualToSpecificationTest() {
		TetrahedronEqualToSpecificationImpl tetrahedronEqualToSpecification = new TetrahedronEqualToSpecificationImpl(new SingleIntegerTetrahedronCriterionImpl(new IdTetrahedronAccessorImpl(), 10));
	...
	public void TetrahedronLessThanDoubleSpecificationTest() {
		TetrahedronLessThanDoubleSpecificationImpl tetrahedronLessThanDoubleSpecification = new TetrahedronLessThanDoubleSpecificationImpl(new SingleDoubleTetrahedronCriterionImpl(new CoordinateXVertexTetrahedronAccessorImpl(new VertexATetrahedronTetrahedronAccessorImpl()), 4.0));
	...
	public void TetrahedronMoreThanDoubleSpecificationTest() {
		TetrahedronMoreThanDoubleSpecificationImpl tetrahedronMoreThanDoubleSpecification = new TetrahedronMoreThanDoubleSpecificationImpl(new SingleDoubleTetrahedronCriterionImpl(new CoordinateXVertexTetrahedronAccessorImpl(new VertexATetrahedronTetrahedronAccessorImpl()), 4.0));
	...
	public void TetrahedronLessThanIntegerSpecificationTest() {
		TetrahedronLessThanIntegerSpecificationImpl tetrahedronLessThanIntegerSpecification = new TetrahedronLessThanIntegerSpecificationImpl(new SingleIntegerTetrahedronCriterionImpl(new IdTetrahedronAccessorImpl(), 11));
	...
	public void TetrahedronMoreThanIntegerSpecificationTest() {
		TetrahedronMoreThanIntegerSpecificationImpl tetrahedronMoreThanIntegerSpecification = new TetrahedronMoreThanIntegerSpecificationImpl(new SingleIntegerTetrahedronCriterionImpl(new IdTetrahedronAccessorImpl(), 0));
	...
	public void TetrahedronBetweenDoubleSpecificationTest() {
		TetrahedronBetweenDoubleSpecificationImpl tetrahedronBetweenDoubleSpecification = new TetrahedronBetweenDoubleSpecificationImpl(new BetweenDoubleTetrahedronCriterionImpl(new CoordinateXVertexTetrahedronAccessorImpl(new VertexATetrahedronTetrahedronAccessorImpl()), 4.0, 6.0));
	...
	public void TetrahedronBetweenIntegerSpecificationTest() {
		TetrahedronBetweenIntegerSpecificationImpl tetrahedronBetweenIntegerSpecification = new TetrahedronBetweenIntegerSpecificationImpl(new BetweenIntegerTetrahedronCriterionImpl(new IdTetrahedronAccessorImpl(), 1, 5));
	...
	public void TetrahedronAndSpecificationTest() {
		...
		TetrahedronSpecification tetrahedronSpecification = tetrahedronLessThanIntegerSpecification.and(tetrahedronMoreThanIntegerSpecification);
	...
	public void TetrahedronOrSpecificationTest() {
		...
		TetrahedronSpecification tetrahedronSpecification = tetrahedronMoreThanDoubleSpecification.or(tetrahedronMoreThanIntegerSpecification);
