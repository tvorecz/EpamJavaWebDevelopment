...
import by.training.zorich.storage.criterion.impl.SingleStringTetrahedronCriterionImpl;
...
import by.training.zorich.storage.specification.impl.TetrahedronBetweenDoubleSpecificationImpl;
import by.training.zorich.storage.specification.impl.TetrahedronEqualToSpecificationImpl;
import by.training.zorich.storage.specification.impl.TetrahedronMoreThanDoubleSpecificationImpl;
import by.training.zorich.storage.specification.impl.TetrahedronMoreThanIntegerSpecificationImpl;
...
public class TetrahedronRepositoryImplTest {
	...
	public void createTestData() {
		...
		tetrahedronThird = new Tetrahedron(new Point(1, 2, 3),
										   new Point(2, -6, 4),
										   new Point(4, 2, -6),
										   new Point(9, 9, -2));
		...
		tetrahedronFourth = new Tetrahedron(new Point(0, 0, 0),
											new Point(2, 0, 0),
											new Point(0, 3, 8),
											new Point(1, 9, 9));
		...
		tetrahedronFifth = new Tetrahedron(new Point(3, 3, 0),
										   new Point(-2, 1, 0),
										   new Point(6, 5, 11),
										   new Point(0, 1, 9));
		...
		tetrahedronSixth = new Tetrahedron(new Point(3, 3, 3),
										   new Point(2, 1, 10),
										   new Point(6, 5, 11),
										   new Point(10, 1, 9));
	...
	public void addTetrahedronsTest() {
		...
		BetweenDoubleTetrahedronCriterionImpl betweenDoubleTetrahedronCriterion = new BetweenDoubleTetrahedronCriterionImpl(
				doubleFieldTetrahedronAccessor,
				1.0,
				6.0);
		TetrahedronSpecification tetrahedronSpecification = new TetrahedronBetweenDoubleSpecificationImpl(
				betweenDoubleTetrahedronCriterion);
	...
	public void removeTetrahedronsTest() {
		...
		SingleIntegerTetrahedronCriterionImpl singleIntegerTetrahedronCriterion = new SingleIntegerTetrahedronCriterionImpl(
				idTetrahedronAccessor,
				1);
		TetrahedronSpecification tetrahedronSpecification = new TetrahedronMoreThanIntegerSpecificationImpl(
				singleIntegerTetrahedronCriterion);
	...
	public void updateTetrahedronsTest() {
		...
		SingleIntegerTetrahedronCriterionImpl singleIntegerTetrahedronCriterion = new SingleIntegerTetrahedronCriterionImpl(
				idTetrahedronAccessor,
				5);
		TetrahedronSpecification tetrahedronSpecification = new TetrahedronEqualToSpecificationImpl(
				singleIntegerTetrahedronCriterion);
		...
		TetrahedronZCoordinateUpdaterImpl tetrahedronZCoordinateUpdater = new TetrahedronZCoordinateUpdaterImpl(new VertexDTetrahedronTetrahedronAccessorImpl(),
																												10.0,
	...
	public void queryTestByName() {
		...
		SingleStringTetrahedronCriterionImpl singleStringTetrahedronCriterion = new SingleStringTetrahedronCriterionImpl(
				nameTetrahedronAccessor,
				tetrahedronThird.getName());
		TetrahedronSpecification tetrahedronSpecification = new TetrahedronEqualToSpecificationImpl(
				singleStringTetrahedronCriterion);
	...
	public void queryTestByCoordinatesQuadrant() {
		...
		//point A
		CoordinateXVertexTetrahedronAccessorImpl coordinateXVertexTetrahedronAccessor = new CoordinateXVertexTetrahedronAccessorImpl(
				vertexATetrahedronTetrahedronAccessor);
		CoordinateYVertexTetrahedronAccessorImpl coordinateYVertexTetrahedronAccessor = new CoordinateYVertexTetrahedronAccessorImpl(
				vertexATetrahedronTetrahedronAccessor);
		CoordinateZVertexTetrahedronAccessorImpl coordinateZVertexTetrahedronAccessor = new CoordinateZVertexTetrahedronAccessorImpl(
				vertexATetrahedronTetrahedronAccessor);


		TetrahedronSpecification tetrahedronSpecification = new TetrahedronMoreThanDoubleSpecificationImpl(new SingleDoubleTetrahedronCriterionImpl(
				coordinateXVertexTetrahedronAccessor,
				0.0)).
							 and(new TetrahedronMoreThanDoubleSpecificationImpl(new SingleDoubleTetrahedronCriterionImpl(
									 coordinateYVertexTetrahedronAccessor,
									 0.0))).
							 and(new TetrahedronMoreThanDoubleSpecificationImpl(new SingleDoubleTetrahedronCriterionImpl(
									 coordinateZVertexTetrahedronAccessor,
									 0.0)));

		//point B
		coordinateXVertexTetrahedronAccessor = new CoordinateXVertexTetrahedronAccessorImpl(
				vertexBTetrahedronTetrahedronAccessor);
		coordinateYVertexTetrahedronAccessor = new CoordinateYVertexTetrahedronAccessorImpl(
				vertexBTetrahedronTetrahedronAccessor);
		coordinateZVertexTetrahedronAccessor = new CoordinateZVertexTetrahedronAccessorImpl(
				vertexBTetrahedronTetrahedronAccessor);

		tetrahedronSpecification = tetrahedronSpecification.and(new TetrahedronMoreThanDoubleSpecificationImpl(new SingleDoubleTetrahedronCriterionImpl(
				coordinateXVertexTetrahedronAccessor,
				0.0)).
							 and(new TetrahedronMoreThanDoubleSpecificationImpl(new SingleDoubleTetrahedronCriterionImpl(
									 coordinateYVertexTetrahedronAccessor,
		...
		//point C
		coordinateXVertexTetrahedronAccessor = new CoordinateXVertexTetrahedronAccessorImpl(
				vertexCTetrahedronTetrahedronAccessor);
		coordinateYVertexTetrahedronAccessor = new CoordinateYVertexTetrahedronAccessorImpl(
				vertexCTetrahedronTetrahedronAccessor);
		coordinateZVertexTetrahedronAccessor = new CoordinateZVertexTetrahedronAccessorImpl(
				vertexCTetrahedronTetrahedronAccessor);
		...
		//point D
		coordinateXVertexTetrahedronAccessor = new CoordinateXVertexTetrahedronAccessorImpl(
				vertexDTetrahedronTetrahedronAccessor);
		coordinateYVertexTetrahedronAccessor = new CoordinateYVertexTetrahedronAccessorImpl(
				vertexDTetrahedronTetrahedronAccessor);
		coordinateZVertexTetrahedronAccessor = new CoordinateZVertexTetrahedronAccessorImpl(
				vertexDTetrahedronTetrahedronAccessor);
	...
	public void queryTestBySquareRange() {
		TotalSquareTetrahedronAccessorImpl totalSquareTetrahedronAccessor = new TotalSquareTetrahedronAccessorImpl(
				TetrahedronRegisterImpl.getInstance());
		BetweenDoubleTetrahedronCriterionImpl betweenDoubleTetrahedronCriterion = new BetweenDoubleTetrahedronCriterionImpl(
				totalSquareTetrahedronAccessor,
				10.0,
				20.0);
	...
	public void queryTestByCoordinatesDistance() {
		...
		TetrahedronSpecification tetrahedronSpecification = new TetrahedronBetweenDoubleSpecificationImpl(new BetweenDoubleTetrahedronCriterionImpl(
				coordinateXVertexTetrahedronAccessor,
				0.0,
				11.0)).
							  and(new TetrahedronBetweenDoubleSpecificationImpl(new BetweenDoubleTetrahedronCriterionImpl(
									  coordinateYVertexTetrahedronAccessor,
									  0.0,
									  11.0))).
							  and(new TetrahedronBetweenDoubleSpecificationImpl(new BetweenDoubleTetrahedronCriterionImpl(
		...
		tetrahedronSpecification = tetrahedronSpecification.and(new TetrahedronBetweenDoubleSpecificationImpl(new BetweenDoubleTetrahedronCriterionImpl(
				coordinateXVertexTetrahedronAccessor,
				0.0,
				11.0)).
							  and(new TetrahedronBetweenDoubleSpecificationImpl(new BetweenDoubleTetrahedronCriterionImpl(
