...
public class TetrahedronCoordinateUpdaterTest {
	...
	public void TetrahedronXCoordinateUpdaterTest() {
		...
		TetrahedronXCoordinateUpdaterImpl tetrahedronXCoordinateUpdater = new TetrahedronXCoordinateUpdaterImpl(new VertexATetrahedronTetrahedronAccessorImpl(), 2, calculateUpdatingValue);
	...
	public void TetrahedronYCoordinateUpdaterTest() {
		...
		TetrahedronYCoordinateUpdaterImpl tetrahedronYCoordinateUpdater = new TetrahedronYCoordinateUpdaterImpl(new VertexATetrahedronTetrahedronAccessorImpl(), 2, calculateUpdatingValue);
	...
	public void TetrahedronZCoordinateUpdaterTest() {
		...
		TetrahedronZCoordinateUpdaterImpl tetrahedronZCoordinateUpdater = new TetrahedronZCoordinateUpdaterImpl(new VertexATetrahedronTetrahedronAccessorImpl(), 2, calculateUpdatingValue);
	...
	public void TetrahedronAndCoordinateUpdaterTest() {
		...
		TetrahedronZCoordinateUpdaterImpl tetrahedronZCoordinateUpdater = new TetrahedronZCoordinateUpdaterImpl(new VertexATetrahedronTetrahedronAccessorImpl(), 2, calculateUpdatingValue);
		TetrahedronUpdater tetrahedronUpdater = tetrahedronZCoordinateUpdater.and(new TetrahedronZCoordinateUpdaterImpl(new VertexATetrahedronTetrahedronAccessorImpl(), 10, calculateUpdatingValue));
