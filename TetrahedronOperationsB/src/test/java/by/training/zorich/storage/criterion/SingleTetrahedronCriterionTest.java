...
import by.training.zorich.storage.accessor.impl.NameTetrahedronAccessorImpl;
...
public class SingleTetrahedronCriterionTest {
	...
	public void testSingleStringTetrahedronCriterionField() {
		SingleTetrahedronCriterion singleTetrahedronCriterion = new SingleStringTetrahedronCriterionImpl(new NameTetrahedronAccessorImpl(),
																										 String.format(
																												 tetrahedronName,
																												 tetrahedronId));
	...
	public void testSingleIntegerTetrahedronCriterionField() {
		SingleTetrahedronCriterion singleTetrahedronCriterion = new SingleIntegerTetrahedronCriterionImpl(new IdTetrahedronAccessorImpl(),
																										  tetrahedronId);
	...
	public void testSingleDoubleTetrahedronCriterionField() {
		SingleTetrahedronCriterion singleTetrahedronCriterion = new SingleDoubleTetrahedronCriterionImpl(new CoordinateXVertexTetrahedronAccessorImpl(
				new VertexATetrahedronTetrahedronAccessorImpl()), 2.0);
